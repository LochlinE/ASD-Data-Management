...
```{r}
#repRef <- lapply(fileNames, readRaw,location = reflectanceFileStorage) %>% #, location = reflectanceFileStorage
 # bind_rows %>%
  #inner_join(filesTable) %>% # This join gives us the fields: Replicate, fileIdx, time, potSize, plantingType, plantName 
